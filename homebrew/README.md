...
| 레포 | 역할 |
|---|---|
| `nu-tree/navis` (모노레포) | navis 소스 코드 |
...
`https://github.com/nu-tree/navis/archive/refs/tags/v0.1.0.tar.gz`

### 4) Formula 의 sha256 채우기

```bash
curl -sL https://github.com/nu-tree/navis/archive/refs/tags/v0.1.0.tar.gz | shasum -a 256
...
# 2) sha256 다시 계산
curl -sL https://github.com/nu-tree/navis/archive/refs/tags/v0.1.1.tar.gz | shasum -a 256
